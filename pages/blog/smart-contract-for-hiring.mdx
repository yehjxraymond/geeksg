...
So we remodeled <a href="https://ethernaut.zeppelin.solutions/">Ethernaut</a> into a coding challenge platform with its leaderboard.
...
Knowing this is a side-project to our work at <a href="https://opencerts.io/">OpenCerts</a>, we didn’t really want to reinvent the wheel as much as possible and make use of resources that are already available. My eyes fell on forking Ethernaut as the base for the coding challenge platform. 
