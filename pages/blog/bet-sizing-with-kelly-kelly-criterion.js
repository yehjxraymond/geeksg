...
const Content = () => (
  <div>
    ...
    <p>
      The wheel seemed to be rigged to your favor - with 1 in 6 chance to triple
      your bet, 1 in 2 chance to double your bet, 1 in 6 chance to get back what
      you've bet and only 1 in 6 chance to lose what you've bet. The game master
      tells you that the casino had made way too much money last year and has
      created this game to give back.
    </p>
    <p>
      Everyone in line get <strong>20 spins</strong> at the game. You start with{" "}
      <strong>$100</strong> and can{" "}
    ...
    <p>
      How will you bet to maximise your final balance (and maybe take the casino
      home)?
    </p>
    ...
    <Game />
    <p>
      By this time you may have figured that the way to maximise the earnings is
      to bet a ratio of your total balance for each spin. But what ratio will
      that be?
    </p>
    <p>
    ...
    <p>
      Too little, you are not exactly compounding your winnings. After all, you
      only gets 20 spins.
    </p>
    <p>
      To help you play many games at once, I've included a simulator below. For
      a start, you may tinker with the{" "}
      <strong>Percentage of wealth to bet</strong> to simulate how much you will
      walk away with by betting a fixed percentage of your balance.
    </p>
    <p>
      Keep a lookout on the <strong>median</strong> balance as that will be the
      number you most likely walk away with. Also, keep a lookout of the
    ...
    <StrategySimulator />
    <p>
      At this point, you probably tried simulating with a few ratios (including
      100% I suppose). You would have realised the perfect ratio is between the
      range from 55% to 75%.
    </p>
    <p>
    ...
    <p>
      ...
      <strong>p</strong>) is 5/6 and that of losing (<strong>q</strong>) is 1/6.
      The only problem is calculating <strong>b</strong>.
    </p>
    <p>
    ...
    <p>
      Naturally, this post is not about a fictitious casino that is dumb enough
      to offer you a game that could potentially bankrupt them.
    </p>
    <p>
      This post is to help you manage the risk of a financial asset by adjusting
      the amount invested in a single asset. Other than determining what
      fraction to wealth to allocate to an asset to limit your risk, Kelly
      Criterion can also be used to determine how much to leverage (since the
    ...
    <p>
      If you are interested to learn more about risk management with Kelly, here
      are some areas to read up on:
    </p>
    <ul>
    ...
    <p>
      <small>
        Ps. If you find this interactive post helpful in helping you learn more
        about finance, please share it with your friends!
      </small>
    </p>
  </div>
);
