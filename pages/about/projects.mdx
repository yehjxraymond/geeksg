...
<div class="text-center m-4">
  <img src="/static/images/about/projects/mycareersfuture.png" className="w-50" />
</div>
...
<div class="text-center m-4">
  <img src="/static/images/about/projects/wielded-token-creator.png" className="w-50" />
</div>
...
<div class="text-center m-4">
  <img src="/static/images/about/projects/quoine-top-trader.png" className="w-50" />
</div>

Having worked on a inter-exchange arbitrage bot, I began to wonder if cryptocurrency exchanges checks for intra-exchange arbitrage opportunities and found one that didn't. Essentially the method will involve a series of trade that changes one product to another and eventually back to itself, with resulting yield greater than 1. For example, BTC -> ETH -> XRP -> BTC. Using the Bellman-Ford algorithm, I'm able to spot these opportunities and built a bot around the theory. In practice, this bot has traded > 10 million dollars in volume and have netted myself an iPhone X for being the top trader (in volume) in December 2017.
...
<div class="text-center m-4">
  <img src="/static/images/about/projects/tht-document-management-system.png" className="w-50" />
</div>
...
<div class="text-center m-4">
  <img src="/static/images/about/projects/capitaland-gto-formatter.png" className="w-50" />
</div>
...
<div class="text-center m-4">
  <img src="/static/images/about/projects/sales-report-cruncher.png" className="w-50" />
</div>
...
<div class="text-center m-4">
  <img src="/static/images/about/projects/ntu-switchblade.png" className="w-50" />
</div>
