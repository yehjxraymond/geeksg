...
<div className="text-center m-4">
  <img src="/images/about/projects/opencerts.png" className="w-50" />
</div>
...
<div className="text-center m-4">
  <img src="/images/about/projects/quiz-apps.png" className="w-50" />
</div>
...
<div className="text-center m-4">
  <img
    src="/images/about/projects/mycareersfuture.png"
    className="w-50"
  />
</div>
...
<div className="text-center m-4">
  <img
    src="/images/about/projects/wielded-token-creator.png"
    className="w-50"
  />
</div>
...
<div className="text-center m-4">
  <img
    src="/images/about/projects/quoine-top-trader.png"
    className="w-50"
  />
</div>
...
<div className="text-center m-4">
  <img
    src="/images/about/projects/tht-document-management-system.png"
    className="w-50"
  />
</div>
...
<div className="text-center m-4">
  <img src="/images/about/projects/queue-ninja.png" className="w-50" />
</div>
...
<div className="text-center m-4">
  <img
    src="/images/about/projects/capitaland-gto-formatter.png"
    className="w-50"
  />
</div>
...
<div className="text-center m-4">
  <img
    src="/images/about/projects/sales-report-cruncher.png"
    className="w-50"
  />
</div>
...
<div className="text-center m-4">
  <img src="/images/about/projects/skycourier.png" className="w-50" />
</div>
...
<div className="text-center m-4">
  <img src="/images/about/projects/geckomarket.png" className="w-50" />
</div>
...
<div className="text-center m-4">
  <img
    src="/images/about/projects/ntu-switchblade.png"
    className="w-50"
  />
</div>
