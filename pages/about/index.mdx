...
I am currently working on [OpenCerts](https://opencerts.io/), a digital certificate framework to issue and verify education credentials on the blockchain. I'm subscribed to the belif that end-users should have control over their data, and that what OpenCerts is built upon. I enjoy evangelising the inversion of control of data and embedding trust in the new web, towards web 3.0.
